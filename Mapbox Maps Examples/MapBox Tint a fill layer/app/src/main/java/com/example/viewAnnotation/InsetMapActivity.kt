...
import com.example.mapboxanimatedweatherdata.databinding.ActivityInsetMapBinding

import com.example.viewAnnotation.fragment.MapFragment
...
// Add fragmentMap fragment to parent container
            //transaction.add(R, insetMapFragment, INSET_FRAGMENT_TAG)
            transaction.commit()
        }
